...
def g_profile (data):
    ...
    fourth_quarter = []
    for x in data:
        if data[x]['month of birth'] == 'january' or data[x]['month of birth'] == 'february' or data[x]['month of birth'] == 'march' :
             first_quarter.append(data[x])
        elif data[x]['month of birth'] == 'may' or data[x]['month of birth'] == 'june' or data[x]['month of birth'] == 'april' :
             second_quarter.append(data[x])
        elif data[x]['month of birth'] == 'july'or data[x]['month of birth'] == 'august' or data[x]['month of birth'] == 'september':
             third_quarter.append(data[x])
        elif data[x]['month of birth'] == 'october' or data[x]['month of birth'] == 'november' or data[x]['month of birth'] == 'december':
